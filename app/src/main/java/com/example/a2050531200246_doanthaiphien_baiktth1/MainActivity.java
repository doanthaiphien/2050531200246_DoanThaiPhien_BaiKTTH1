package com.example.a2050531200246_doanthaiphien_baiktth1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (usernameLogin.getText().toString().equals("doanthaiphien") && passLogin.getText().toString().equals("2050531200246")) {
